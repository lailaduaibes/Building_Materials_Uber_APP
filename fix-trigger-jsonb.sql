-- QUICK FIX: Update the trigger function to use proper JSONB format
-- Execute this in Supabase SQL Editor to fix the approval error
       ...
       AND NEW.vehicle_plate != 'TBD' THEN
        ...
        ELSIF NEW.has_custom_truck_type = true AND NEW.custom_truck_type_name IS NOT NULL THEN
            ...
            INSERT INTO truck_types (
                ...
                '["General"]'::jsonb, -- FIXED: Proper JSONB format
                2.50, -- Default rate
